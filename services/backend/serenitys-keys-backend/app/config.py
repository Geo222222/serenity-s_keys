...
class Settings(BaseSettings):
    ...
    from_email: str = Field(default="no-reply@serenitykeys.com", alias="FROM_EMAIL")
    contact_inbox_email: str = Field(default="hello@serenitykeys.com", alias="CONTACT_INBOX_EMAIL")
